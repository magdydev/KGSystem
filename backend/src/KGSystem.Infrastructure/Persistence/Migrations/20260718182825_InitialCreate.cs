        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppNameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuardianNameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    GuardianNameEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KGPhases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyFees_AcademicYears_AcademicYearId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChildId = table.Column<int>(type: "int", nullable: false),
                    KGPhaseId = table.Column<int>(type: "int", nullable: false),
                    AcademicYearId = table.Column<int>(type: "int", nullable: false),
                    EnrollmentDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Enrollments_KGPhases_KGPhaseId",
                        column: x => x.KGPhaseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Children_GuardianPhone",
                table: "Children",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_ChildId_KGPhaseId_AcademicYearId",
                table: "Enrollments",
                columns: new[] { "ChildId", "KGPhaseId", "AcademicYearId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_KGPhaseId",
                table: "Enrollments",
                column: "KGPhaseId");

            migrationBuilder.CreateIndex(
                name: "IX_KGPhases_Code",
                table: "KGPhases",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_EnrollmentId_Month_Year",
                table: "Payments",
